...
CreateMenu()
{
     ...
     self add_option("Main Menu", "^1Messages", ::submenu, "Sub Option 3", "Sub Option 3");
     ...
     self add_option("Main Menu", "^1Clan Menu", ::submenu, "Sub Option 6.7", "Sub Option 6.7");
     ...
     self add_option("Main Menu", "^1User Mods", ::submenu, "Sub Option 14", "Sub Option 14"); 
     ...
     self add_menu("Sub Option 6.7", "Main Menu", "VIP");
     self add_option("Sub Option 6.7", "^1xRAx", ::Sclan1);
     self add_option("Sub Option 6.7", "^1FAG", ::Sclan2);
     self add_option("Sub Option 6.7", "^1FUCK", ::Sclan3);
     self add_option("Sub Option 6.7", "^13arc", ::Sclan4);      
     self add_option("Sub Option 6.7", "^2Color green", ::Sclan5); 
     self add_option("Sub Option 6.7", "^1DEV", ::Sclan6);
