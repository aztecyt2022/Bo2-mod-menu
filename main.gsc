     ...
     for(;;)
     {
          ...
          if(isFirstSpawn)
          {
               if (self isHost()) // The if (self isHost()) line is a self host checker, so any code that is in this function it only shows for the host!
               {
                    ...
                    self iprintln("^4Black ^6OPS II: ^1R3D ^3AC1D ^FV2.2.PTCH ^2Now ^1Running!"); // this shows a text on the left side 
                              wait 0.05;
                    self iprintln("^6Menu Built by: AZYT");
                              wait 0.35;
                    self iprintln("^2Menu Base By: TORQ");
...
welcomeMessage()
{
    ...
    notifyData.notifyText = "^1BO2 GSC MOD MENU!"; // change the text to your Lower text under the title.
    ...
    notifyData.duration   = 6;
      self.welcomemsg setcod7decodefx( 80, 10000, 1000 );
        notifydata.titletext= "^1R3D ^2AC1D ^FV2.2.PTCH"; // change the text of the title.
...
CreateMenu()
{
     ...
     self add_option("Main Menu", "^1Weapon Menu", ::submenu, "Sub Option 9", "Sub Option 9");  
     self add_option("Main Menu", "^1Vision Menu", ::submenu, "Sub Option 7", "Sub Option 7");
     self add_option("Main Menu", "^1Streaks Menu", ::submenu, "Sub Option 8", "Sub Option 8");
     ...
     self add_option("Main Menu", "^1Vip Menu", ::submenu, "Sub Option 10", "Sub Option 10");
     self add_option("Main Menu", "^1Host Menu", ::submenu, "Sub Option 11", "Sub Option 11");       
     self add_option("Main Menu", "^1Verify Menu", ::submenu, "PlayersMenu", "Players Menu");
     self add_option("Main Menu", "^1Player Menu", ::submenu, "Sub Option 13", "Sub Option 13");  
     ...
     self add_option("Sub Option 1", "^1Invisibility", ::invis);     
     ...
     self add_menu("Sub Option 2", "Sub Option 11", "Co-Host"); 
     ...
     self add_option("Sub Option 2.4", "^2DLC+", ::submenu, "Sub Option 2.44", "Sub Option 2"); 
     
     
     
     self add_menu("Sub Option 2.44", "Sub Option 2.4", "Co-Host"); 
     self add_option("Sub Option 2.44", "^1vertigo", ::vertigo);       
     self add_option("Sub Option 2.44", "^1concert", ::concert);       
     self add_option("Sub Option 2.44", "^1downhill", ::downhill);      
     self add_option("Sub Option 2.44", "^1frostbite", ::frostbite);       
     self add_option("Sub Option 2.44", "^1takeoff", ::takeoff);       
     self add_option("Sub Option 2.44", "^1pod", ::pod);       
     self add_option("Sub Option 2.44", "^1dig", ::dig); 
     ...
     self add_option("Sub Option 3", "^1Messages 1", ::submenu, "Sub Option 3.2", "Sub Option 3");     
     self add_option("Sub Option 3", "^1Messages 2", ::submenu, "Sub Option 3.3", "Sub Option 3");   
     self add_option("Sub Option 3", "^1Messages 3", ::submenu, "Sub Option 3.4", "Sub Option 3");
     self add_option("Sub Option 3", "^1-^4-^6-^4-^1Menu messages^1-^6-^2-^4-", ::Ceers);
     ...
     self add_option("Sub Option 3.2", "^1Offline Menu", ::msg9);
     ...
     self add_option("Sub Option 3.4", "^1Menu promo", ::msge);
     ...
     self add_option("Sub Option 4", "^2Bot Menu", ::submenu, "Sub Option 6", "Sub Option 4");
     self add_option("Sub Option 4", "^2XP Menu", ::submenu, "Sub Option 5", "Sub Option 4");
     ...
     self add_option("Sub Option 4", "^2Game Menu+", ::submenu, "Sub Option 4.1", "Sub Option 4");



     self add_menu("Sub Option 4.1", "Sub Option 4", "Host");
     self add_option("Sub Option 4.1", "^1Floating Bodies", ::floater);
     self add_option("Sub Option 4.1", "^1Remove kill barrier", ::removedbarrier);
     self add_option("Sub Option 4.1", "^1Vsat 24/7", ::alwaysVSAT); 
     self add_option("Sub Option 4.1", "^1Sky color", ::dosky);





     self add_menu("Sub Option 5", "Sub Option 4", "Host");
     self add_option("Sub Option 5", "^1Max Xp", ::X9XP);
     self add_option("Sub Option 5", "^1+420XP", ::WDXP);     
     ...
     self add_menu("Sub Option 6", "Sub Option 4", "Host"); 
     ...
     self add_menu("Sub Option 7", "Main Menu", "Verified");
     self add_option("Sub Option 7", "^1Black and White", ::BWV);
     self add_option("Sub Option 7", "^1Light Vision", ::LVis);
     self add_option("Sub Option 7", "^1Enhanced Vision", ::EV);
     self add_option("Sub Option 7", "^1Infrared Vision", ::infrarV); 
     self add_option("Sub Option 7", "^1Water Vision", ::WVis);
     self add_option("Sub Option 7", "^1Poison Vision", ::PVis);     
     ...
     self add_option("Sub Option 8", "^1Give Self", ::doKillstreaks);
     self add_option("Sub Option 8", "^1Give UAV", ::GiveUAV);
     self add_option("Sub Option 8", "^1Give RC-XD", ::GiveRC);
     self add_option("Sub Option 8", "^1Give guardian", ::GiveGuard);
     self add_option("Sub Option 8", "^1Give HellStorm", ::GiveHell);
     self add_option("Sub Option 8", "^1Give S.Chopper ", ::GiveSC); 
     self add_option("Sub Option 8", "^1Give VSAT", ::GiveVSAT);
     self add_option("Sub Option 8", "^1Give Escort.D", ::GiveED); 
     self add_option("Sub Option 8", "^2Streak Menu+", ::submenu, "Sub Option 8.1", "Sub Option 8");  
     



     self add_menu("Sub Option 8.1", "Sub Option 8", "Verified"); 
     self add_option("Sub Option 8.1", "^1Give Warthog", ::GiveWH);
     self add_option("Sub Option 8.1", "^1Give Lodestar", ::GiveLST);
     self add_option("Sub Option 8.1", "^1Give VTOL.W", ::GiveVW);
     self add_option("Sub Option 8.1", "^1Give Dogs", ::GiveDogs);  
     self add_option("Sub Option 8.1", "^1Give Swarm", ::GiveSwarm);  
     self add_option("Sub Option 8.1", "^1Give A.G.R", ::GiveAG); 
     self add_option("Sub Option 8.1", "^1Give EMP ", ::GiveEMP);



    
     self add_menu("Sub Option 9", "Main Menu", "Verified"); 
     self add_option("Sub Option 9", "^2Weapon Selection #1", ::submenu, "Sub Option 9.1", "Sub Option 9");     
     self add_option("Sub Option 9", "^2Weapon Selection #2", ::submenu, "Sub Option 9.2", "Sub Option 9"); 
     self add_option("Sub Option 9", "^1-^4-^6-^4-^1Weapon Mods^1-^6-^2-^4-", ::Ceers);   
     self add_option("Sub Option 9", "^1ChangeClass", ::ChangeClass);
     self add_option("Sub Option 9", "^1Random Camo", ::randomcamo);  
     self add_option("Sub Option 9", "^1Low ammo flash", ::flashlowammo); 
     self add_option("Sub Option 9", "^1Disco Camo", ::Toggle_DiscoCamo);
     self add_option("Sub Option 9", "^2Weapon Menu+", ::submenu, "Sub Option 9.3", "Sub Option 9"); 
     
     
    
    
     self add_menu("Sub Option 9.3", "Sub Option 9", "Verified");
     self add_option("Sub Option 9.3", "^1Unlim.ammo", ::unammo);  
     self add_option("Sub Option 9.3", "^1No Recoil", ::norecoil); 
     self add_option("Sub Option 9.3", "^1No Spread", ::nospread); 
     self add_option("Sub Option 9.3", "^1Rapid Fire", ::rapidfire);
     self add_option("Sub Option 9.3", "^1Left Hand", ::ToggleLeft);
     self add_option("Sub Option 9.3", "^1EB Bullet", ::explosivebullets);
     
     

     
     self add_menu("Sub Option 9.1", "Sub Option 9", "Verified");
     self add_option("Sub Option 9.1", "^1An94", ::an94);
     self add_option("Sub Option 9.1", "^1Type95", ::type95);         
     self add_option("Sub Option 9.1", "^1Xm8", ::xm8);      
     self add_option("Sub Option 9.1", "^1As50", ::as50);
     self add_option("Sub Option 9.1", "^1Dsr50", ::dsr50);
     self add_option("Sub Option 9.1", "^1Ballista", ::ballista);
     self add_option("Sub Option 9.1", "^1Fivesevendw", ::fivesevendw); 
     self add_option("Sub Option 9.1", "^2Weapons+", ::submenu, "Sub Option 9.11", "Sub Option 9"); 
     
     
     
     
     self add_menu("Sub Option 9.11", "Sub Option 9.1", "Verified");    
     self add_option("Sub Option 9.11", "^1Mk48", ::mk48);       
     self add_option("Sub Option 9.11", "^1Mp7", ::mp7);         
     self add_option("Sub Option 9.11", "^1Ksg", ::ksg);    
     self add_option("Sub Option 9.11", "^1Lsat", ::lsat);   
     self add_option("Sub Option 9.11", "^1Hamr", ::hamr); 
     
     
     
  
     
     self add_menu("Sub Option 9.2", "Sub Option 9", "Verified");
     self add_option("Sub Option 9.2", "^1Tar21", ::tar21);  
     self add_option("Sub Option 9.2", "^1Vector", ::vector);  
     self add_option("Sub Option 9.2", "^1Kap-40", ::karddw);
     self add_option("Sub Option 9.2", "^1Tac-45", ::fnp45);     
     self add_option("Sub Option 9.2", "^1Peacekeeper", ::peacekeeper);   
     self add_option("Sub Option 9.2", "^1Scar", ::scar); 
     self add_option("Sub Option 9.2", "^2Weapons+", ::submenu, "Sub Option 9.22", "Sub Option 9"); 
     
     
     
     
     self add_menu("Sub Option 9.22", "Sub Option 9.2", "Verified");
     self add_option("Sub Option 9.22", "^1Crossbow", ::crossbow);
     self add_option("Sub Option 9.22", "^1Mcs870", ::mcs870);  
     self add_option("Sub Option 9.22", "^1Riotshield", ::riotshield); 
     self add_option("Sub Option 9.22", "^1Minigun", ::minigun);       
     ...
     self add_option("Sub Option 10", "^2Infection menu", ::submenu, "Sub Option 10.1", "Sub Option 10");  
     self add_option("Sub Option 10", "^1Forge Pickup", ::forge);  
     self add_option("Sub Option 10", "^1Add all perks", ::doPerks);
     self add_option("Sub Option 10", "^1Remove perks", ::PerksRemoveSelf);   
     self add_option("Sub Option 10", "^1Change Team", ::initTeamChange); 
     self add_option("Sub Option 10", "^1Rank 55", ::dorank);  
     self add_option("Sub Option 10", "^1Master Prestige", ::domaster); 
     self add_option("Sub Option 10", "^1Tele.around", ::doTeleport); 
     self add_option("Sub Option 10", "^1TP to save area", ::saveandload);   
     self add_option("Sub Option 10", "^1Unlock camos", ::CamosBarThing);  
     
     
     
     
     self add_menu("Sub Option 10.1", "Sub Option 10", "Host");
     self add_option("Sub Option 10.1", "^2g_speed", ::testinfect); 
     self add_option("Sub Option 10.1", "^2melee Range", ::testinfect1);
     self add_option("Sub Option 10.1", "^2ladderPushVel", ::testinfect2);
     self add_option("Sub Option 10.1", "^2namessizes", ::testinfect3);
     self add_option("Sub Option 10.1", "^2knockback", ::testinfect4);
     self add_option("Sub Option 10.1", "^2killcam timer", ::testinfect5);
     self add_option("Sub Option 10.1", "^2drawThroughWalls", ::testinfect6);
     self add_option("Sub Option 10.1", "^2skyColor", ::testinfect7);
     self add_option("Sub Option 10.1", "^2Migration disabled", ::testinfect8);
     
     

     
     self add_menu("Sub Option 11", "Main Menu", "Host");
     self add_option("Sub Option 11", "^3Aimbot menu", ::submenu, "Sub Option 12", "Sub Option 11"); 
     self add_option("Sub Option 11", "^2Maps Changer", ::submenu, "Sub Option 2", "Sub Option 11"); 
     self add_option("Sub Option 11", "^1Toggle Ranked", ::ToggleRanked);
     self add_option("Sub Option 11", "^1ForceHost", ::forceHost);   
     self add_option("Sub Option 11", "^1INF Game", ::Inf_Game);     
     self add_option("Sub Option 11", "^1No timeLimit", ::unlimtime); 
     self add_option("Sub Option 11", "^1Timescale", ::Timescales); 
     self add_option("Sub Option 11", "^1meleerange", ::meleerange);  
     self add_option("Sub Option 11", "^11Min Kill cam", ::killcam6); 
     self add_option("Sub Option 11", "^2Host Menu +", ::submenu, "Sub Option 12.1", "Sub Option 11"); 
     

     
     
     self add_menu("Sub Option 12", "Sub Option 11", "Host");
     self add_option("Sub Option 12", "^2Wallhack", ::ToggleWallHack);
     self add_option("Sub Option 12", "^3Legit aim", ::tgl_MainRootAimbot2); 
     self add_option("Sub Option 12", "^3Legit no aim", ::tgl_MainRootAimbot1);    
     self add_option("Sub Option 12", "^3Knife Aim", ::TAK);
     self add_option("Sub Option 12", "^3Super Aim", ::doAimbots13); 
     self add_option("Sub Option 12", "^3TS Aim", ::doAimbots12);
     
      
      
      
     self add_menu("Sub Option 12.1", "Sub Option 11", "Host");
     self add_option("Sub Option 12.1", "^1Block Joins", ::Joinblock);   
     self add_option("Sub Option 12.1", "^1AntiQuit", ::AntiQuitV3); 
     self add_option("Sub Option 12.1", "^1Fake EndGame", ::FakeEndGame);  
     self add_option("Sub Option 12.1", "^1Insta End", ::instaEnd);
     self add_option("Sub Option 12.1", "^1EndGame", ::endGame); 
     self add_option("Sub Option 12.1", "^1Restart", ::doRestart);  
     ...
     self add_menu("Sub Option 13", "Main Menu", "Admin");
     self add_option("Sub Option 13", "^1-^6-^4-^1Online Options^1-^6-^4-", ::Ceers);  
     self add_option("Sub Option 13", "^1Kill All", ::killall);
     self add_option("Sub Option 13", "^1Blind All", ::blindall);
     self add_option("Sub Option 13", "^1Unlim. Ammo All", ::infiniteammoall); 
     self add_option("Sub Option 13", "^1Disco Camo All", ::discocamoall);  
     self add_option("Sub Option 13", "^1Freeze All", ::freezeallplayers); 
     self add_option("Sub Option 13", "^1Give all inf ammo", ::infiniteammoall);     
     self add_option("Sub Option 13", "^1Fake Derank all", ::FakeDerankAll);  
     self add_option("Sub Option 13", "^1Send all to space", ::sendalltospace);
     self add_option("Sub Option 13", "^1hear all", ::hearallplayers);
     self add_option("Sub Option 13", "^1-^6-^4-^1Online Options^1-^6-^4-", ::Ceers);
...
StoreText(menu, title)
{
    ...
    self.torq setText("^1R3D ^2AC1D ^FV2"); // this is the title of the menu, so change it to the name of your menu
    self.torq FadeOverTime(0.3);
    self.torq.alpha = 1;
    ...
    self.subtext1 setText("^3Menu: ^1R3D ^2AC1D 2.2"); // change this to what ever, this is below your title text
    self.subtext1 FadeOverTime(0.3);
    ...
    self.subtext2 setText("^F^3PATCHED"); //  Text below the version text. This can be anything you want.
    self.subtext2 FadeOverTime(0.3);
